...
config :fniks_db, FniksDb.Repo,
 username: System.get_env("DB_USER") || "root",
  ...
  database: System.get_env("DB_NAME") || "fniks_db_dev",
...
config :fniks_db_web, FniksDbWeb.Endpoint,
  ...
  watchers: [
    node: [
      ...
      "development",
      "--watch-stdin",
      cd: Path.expand("../apps/fniks_db_web/assets", __DIR__)
    ]
  ]
...
config :fniks_db_web, FniksDbWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/fniks_db_web/(live|views)/.*(ex)$",
      ~r"lib/fniks_db_web/templates/.*(eex)$"
    ]
  ]
